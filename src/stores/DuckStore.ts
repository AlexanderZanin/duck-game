...
export class DuckStore {
  ...
  // Start a flight: place at x=0, y=startY and animate to x=100 over durationMs
  // onFinish is called when the duck reaches the right side (natural end)
